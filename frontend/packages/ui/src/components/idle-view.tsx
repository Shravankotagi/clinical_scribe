...
export function IdleView({ onStartNew }: IdleViewProps) {
  return (
    <div className="flex h-full flex-col items-center justify-center p-8 gap-8" style={{ background: '#fff8f5' }}>
      ...
      <div className="relative group">
        ...
        <button
          ...
          style={{ background: '#129de8', color: 'white' }}
        >
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2" style={{ color: '#8e8470' }}>
          Start a New Session
        </h2>
        <p className="text-lg" style={{ color: '#514535' }}>
      ...
      <div className="flex gap-4 flex-wrap justify-center">
        <div
          ...
          style={{ background: 'white', borderColor: '#d5c4ae', color: '#514535' }}
        >
