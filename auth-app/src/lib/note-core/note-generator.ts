import { runLLMRequest, prompts } from "@/lib/llm"
import { toPipelineStageError } from "@/lib/pipeline-shared/error"
import { 
  extractMarkdownFromResponse, 
  normalizeMarkdownSections,
  createEmptyMarkdownNote 
} from "./clinical-models/markdown-note"
import { debugLog, debugLogPHI, debugError, debugWarn } from "@/lib/scribe-storage"
