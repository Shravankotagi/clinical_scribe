...
export function ModelIndicator({ processingMode }: ModelIndicatorProps) {
  ...
  return (
    <div className="shrink-0 px-4 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.08)', background: '#0A0F2C' }}>
      <p className="mb-2 text-xs font-bold uppercase tracking-wider" style={{ color: 'rgba(255,255,255,0.4)' }}>
        Models
      </p>
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center gap-2 text-xs" style={{ color: 'rgba(255,255,255,0.65)' }}>
          <Cpu className="h-3.5 w-3.5 shrink-0" style={{ color: '#60a5fa' }} />
          <span className="truncate">Whisper (Local)</span>
        </div>
        <div className="flex items-center gap-2 text-xs" style={{ color: 'rgba(255,255,255,0.65)' }}>
          <NoteIcon className="h-3.5 w-3.5 shrink-0" style={{ color: '#60a5fa' }} />
